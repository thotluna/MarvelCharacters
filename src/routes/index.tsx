...
export default component$(() => {
  ...
  return (
    <>
      <header class='w-full flex items-center justify-center bg-red-500 p-8'>
        <h1 class='text-7xl w-full inline-block text-center text-stone-50 '>Marvel Heroes</h1>
      </header>
      <section class='w-full flex justify-center items-center'>
        <div class='p-8 w-full grid  gap-8 justify-between items-center '
